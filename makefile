...
ARDUINO_INC = -I$(INSTALL_DIR)/libraries/SPI \
-I$(HOME)/Documents/Arduino/libraries/Timer1 
...
$(HOME)/Documents/Arduino/libraries/Timer1/TimerOne.cpp \
...
CINCS = -I$(ARDUINO)  -I$(VARIANTS) -I$(ARDUINO_LIB) $(ARDUINO_INC)
CXXINCS = -I$(ARDUINO) -I$(VARIANTS) -I$(ARDUINO_LIB) $(ARDUINO_INC)
